...
namespace CustomMethodBenjamin
{
    public partial class ConDataService
    {
        ...
        public async Task<Models.ConData.ProductCategory> DeleteProductCategory(Int64? categoryId)
        {
        ...
        public async Task<Models.ConData.ProductCategory> GetProductCategoryByCategoryId(Int64? categoryId)
        {
        ...
        public async Task<Models.ConData.ProductCategory> UpdateProductCategory(Int64? categoryId, Models.ConData.ProductCategory productCategory)
        {
